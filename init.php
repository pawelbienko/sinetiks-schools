...
function sinetiks_schools_modifymenu() {
	...
	'sinetiks_schools_update'); //function
        ...
        add_submenu_page('sinetiks_schools_list', //parent slug
	'Scheduler School', //page title
	'Scheduler', //menu title
	'manage_options', //capability
	'sinetiks_schools_scheduler', //menu slug
	'sinetiks_schools_scheduler'); //function
}
...
require_once(ROOTDIR . 'schools-scheduler.php');
